...
export type EditorResourceArticleItemFragment = { __typename?: 'Article', id: string, name: string, thumb?: string | null, status: number, content?: string | null, folder: { __typename?: 'Folder', id?: string | null, name?: string | null } } & { ' $fragmentName'?: 'EditorResourceArticleItemFragment' };

export type InitEditorResourceQueryVariables = Exact<{ [key: string]: never; }>;


export type InitEditorResourceQuery = { __typename?: 'Query', folders: { __typename?: 'Folders', list: Array<(
      { __typename?: 'Folder' }
