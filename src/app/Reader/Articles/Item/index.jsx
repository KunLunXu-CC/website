    ...
    <div
      ...
      <div className={scss.body}>
        <div className={scss.time}>
          ...
          发布于: {moment(props.data.updateTime).format('YYYY-MM-DD')}
        </div>
        <div className={scss.title}>{props.data.name}</div>
        <div className={scss.stats}>
          <Icon type="icon-liulanliang"/>7,000热度&emsp;
          <Icon type="icon-pinglunliang"/>26条评论&emsp;
          <Icon type="icon-biaoqian"/>{props.data.tags?.[0].name}&emsp;
        </div>
